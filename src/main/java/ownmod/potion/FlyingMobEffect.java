...
import ownmod.procedures.FlyingStartProcedure;
import ownmod.procedures.FlyingRevokeProcedure;
...
public class FlyingMobEffect extends MobEffect {
	...
	public String getDescriptionId() {
		return "effect.own_mod.flying";
	}

	@Override
	public void addAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
		FlyingStartProcedure.execute(entity);
	}

	@Override
	public void removeAttributeModifiers(LivingEntity entity, AttributeMap attributeMap, int amplifier) {
		super.removeAttributeModifiers(entity, attributeMap, amplifier);
		FlyingRevokeProcedure.execute(entity);
	}
